...
class UpdateProjectTask extends Component {
    ...
    //     console.log(state)
    //     if (props.project_task.id !== state.id || 
    //         props.project_task.summary !== state.summary ||
    //         props.project_task.acceptanceCriteria !== state.acceptanceCriteria ||
    //         props.project_task.status !== state.status) {
    //             return {
    //                 id: props.project_task.id,
    //                 summary: props.project_task.summary,
    //                 acceptanceCriteria: props.project_task.acceptanceCriteria,
    //                 status: props.project_task.status
    //             }
    //         }
    // }
    componentDidMount(){
